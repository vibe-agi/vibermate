...
test("DMG log must ticket all three embedded Universal executables", () => {
...
test("embedded build manifest is clean distribution provenance", () => {
  ...
  const manifest = {
    ...
    configurationSHA256: {
      "go.mod": "1".repeat(64),
      "go.sum": "2".repeat(64),
      "rust-toolchain.toml": "3".repeat(64),
      "ui/desktop/package.json": "4".repeat(64),
      "ui/desktop/pnpm-lock.yaml": "5".repeat(64),
      "ui/desktop/src-tauri/Cargo.toml": "6".repeat(64),
      "ui/desktop/src-tauri/Cargo.lock": "7".repeat(64),
      "ui/desktop/src-tauri/tauri.conf.json": "8".repeat(64),
    },
    sidecarSHA256: {
      vibermate: "9".repeat(64),
      vibermated: "a".repeat(64),
    },
  };
  assert.equal(
