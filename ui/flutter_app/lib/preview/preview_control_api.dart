    ...
    for (var index = 0; index < 8; index += 1) {
      ...
      final capture = CaptureRecord(
        ...
        managedRun: ManagedRunSummary(
          ...
          clientAdapter: CaptureClientAdapter(
            id: index.isEven ? 'claude-code' : 'codex-cli',
            revision: 1,
            version: index.isEven ? '2.1.220' : '0.145.0',
            catalogRevision: 1,
            source: 'prelaunch_digest_catalog',
            installShape: index.isEven
                ? 'native_single_binary'
                : 'npm_wrapper_native_child',
            launchRecipe: index.isEven
                ? 'node_env_proxy'
