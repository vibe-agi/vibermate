...
final class AppCopy {
  ...
  static const _en = <String, String>{
    ...
    'capture.environment.help':
        'This Environment is frozen for the run. Exit the client and start a new vibermate run to resume on another Environment.',
    ...
    'environment.transform.detail':
        'Only this client protocol path; request runs before Account authentication and response before client delivery.',
  ...
  static const _zh = <String, String>{
    ...
    'capture.environment': 'Environment',
    'capture.environment.help':
        '此 Environment 在本次运行中保持冻结。退出客户端后，通过新的 vibermate run 在另一 Environment 上 resume。',
    'capture.environment.history':
    ...
    'environment.transform.detail': '仅作用于这条客户端协议流量；请求在账号鉴权前、响应在交付客户端前执行。',
