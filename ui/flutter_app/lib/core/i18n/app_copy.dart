...
final class AppCopy {
  ...
  static const _en = <String, String>{
    ...
    'network.connections.latest.detail':
        'One current row per physical connection. Expand for routing evidence. Encrypted passthrough shows destinations and byte counts, not request content.',
  ...
  static const _zh = <String, String>{
    ...
    'network.connections.latest.detail':
        '每条物理连接只显示当前一行；展开可检查路由证据。加密直通只能看到目的地和字节数，无法检查请求内容。',
