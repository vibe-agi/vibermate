...
final class AppCopy {
  ...
  static const _en = <String, String>{
    ...
    'environment.endpoint.add_action': 'Add Route to client flow',
    ...
    'environment.destination.label': 'Where this traffic goes',
    'environment.destination.original': 'Original destination',
    'environment.destination.original.short': 'Direct · original',
    ...
    'environment.destination.original.action': 'Use direct destination',
    'environment.destination.upstream': 'Selected upstream',
    'environment.destination.upstream.short': 'Upstream Endpoint',
  ...
  static const _zh = <String, String>{
    ...
    'environment.endpoint.add_action': '添加到当前客户端流量',
    ...
    'environment.edit.routes.empty':
        '仅抓包 Environment：ViberMate 记录流量，并按每个客户端的原始目标转发。',
    ...
    'environment.destination.label': '这条流量发往哪里',
    'environment.destination.original': '直连原始目标',
    'environment.destination.original.short': '直连原服务',
    'environment.destination.original.detail':
        'ViberMate 仍会抓包；请求发往客户端原本的服务，并沿用原凭据。',
    'environment.destination.original.action': '使用直连目标',
    'environment.destination.upstream': '指定上游',
    'environment.destination.upstream.short': '指定上游 Endpoint',
    'environment.destination.upstream.detail':
