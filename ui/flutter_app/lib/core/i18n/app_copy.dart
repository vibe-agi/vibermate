...
final class AppCopy {
  ...
  static const _en = <String, String>{
    ...
    'server.usage.turns': '{count} turns',
    'server.usage.turns.short': '{count} turns',
    ...
    'server.usage.model.summary': '{turns} turns · {failed} failed',
    ...
    'usage.activity.team.detail':
        'Daily retained turns across Runtime Users; select Token to inspect declared usage.',
    ...
    'usage.activity.metric.turns': 'Turns',
    ...
    'usage.activity.cell.zero': '{date} · no retained turn',
    ...
    'usage.metric.turns': 'Agent turns',
    'usage.metric.turns.detail': 'One terminal Agent API Exchange per turn',
    ...
    'usage.ranking.result': '{turns} turns · {succeeded} succeeded',
    ...
    'usage.models.empty': 'No retained turn contains both exact model IDs.',
    'usage.model.metrics':
        '{turns} turns · {succeeded} succeeded · {failed} failed · in {input} · out {output}',
    ...
    'usage.context.metrics':
        '{device} · {runs} Captures · {turns} turns · in {input} · out {output}',
    'usage.workspace.metrics':
        '{runs} Captures · {turns} turns · {devices} devices · in {input} · out {output}',
    ...
    'usage.session.metrics':
        '{runs} Captures · {turns} turns · {succeeded} succeeded · {failed} failed',
    'usage.empty':
  ...
  static const _zh = <String, String>{
    ...
    'server.usage.turns': '{count} 轮',
    'server.usage.turns.short': '{count} 轮',
    ...
    'server.usage.model.summary': '{turns} 轮 · 失败 {failed}',
    ...
    'usage.activity.cell.zero': '{date} · 无已保留轮次',
    'usage.activity.cell.value':
    ...
    'usage.metric.turns': 'Agent 轮次',
    'usage.metric.turns.detail': '每个终态 Agent API Exchange 计为一轮',
    ...
    'usage.ranking.result': '{turns} 轮 · 成功 {succeeded}',
    ...
    'usage.models.empty': '已保留轮次中没有同时记录两个精确模型 ID。',
    'usage.model.metrics':
        '{turns} 轮 · 成功 {succeeded} · 失败 {failed} · 入 {input} · 出 {output}',
    ...
    'usage.context.metrics':
        '{device} · {runs} 个 Capture · {turns} 轮 · 入 {input} · 出 {output}',
    'usage.workspace.metrics':
        '{runs} 个 Capture · {turns} 轮 · {devices} 台设备 · 入 {input} · 出 {output}',
    ...
    'usage.session.metrics':
        '{runs} 个 Capture · {turns} 轮 · 成功 {succeeded} · 失败 {failed}',
