...
func TestFixedCodexInvocationUsesIsolatedStateAndStandardInput(
	...
	expected := []string{
		...
		"-c",
		`model_providers.vibermate-http={name="ViberMate Responses HTTP",base_url="https://api.openai.com/v1",env_key="CODEX_API_KEY",wire_api="responses",requires_openai_auth=false,supports_websockets=false}`,
		"-a",
		"never",
		"-s",
		"workspace-write",
